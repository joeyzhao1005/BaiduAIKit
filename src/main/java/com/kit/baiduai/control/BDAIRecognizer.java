package com.kit.baiduai.control;
...
import com.kit.baiduai.recognization.RecogEventAdapter;
...
public class BDAIRecognizer {
    ...
    private static final String TAG = "BDAIRecognizer";
     ...
     */
    public BDAIRecognizer(Context context, IRecogListener recogListener) {
     ...
     * @param eventListener
     */
    public BDAIRecognizer(Context context, EventListener eventListener) {
        if (isInited) {
            Zog.e("还未调用release()，请勿新建一个新类");
    ...
    public void loadOfflineEngine(Map<String, Object> params) {
        ...
        Zog.i("loadOfflineEngine params:" + json);
